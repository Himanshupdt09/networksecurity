...
class DataValidationConfig:
    def __init__(self,training_pipeline_connfig:TrainingPipelineConfig):
        self.data_validation_dir:str=os.path.join(training_pipeline_connfig.artifact_dir,training_pipeline.DATA_VALIDATION_DIR_NAME)
